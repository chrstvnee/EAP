<div id="kt_app_sidebar" class="sidebar app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
	...
	data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle" data-kt-menu-expand="false">
	<!--begin::Logo-->
		...
		<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
			...
			<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
				...
				<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
					data-kt-menu="true" data-kt-menu-sub-expand="false">
					<!--begin:Menu item-->
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion hover">
							...
							<span class="menu-link">
								<span class="menu-icon">
									<i class="fa-regular fa-file-plus fs-1"></i>
									<span class="path1"></span>
									<span class="path2"></span>
									</i>
								</span>
