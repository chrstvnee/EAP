...
<div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
    <!--begin::Col-->
    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-md-10 mb-xl-10">
        ...
        <div class="card card-flush">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <!--end::Info-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-500 pt-1 fw-semibold fs-6">Total Employee</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
        ...
        <div class="card card-flush">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <!--end::Info-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-500 pt-1 fw-semibold fs-6">Employment Status</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
