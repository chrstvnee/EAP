<div id="kt_app_sidebar" class="sidebar app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle" data-kt-menu-expand="false">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="index.html">
								<img alt="Logo" src="assets/media/logos/upot.png" class="h-35px app-sidebar-logo-default" />					
								<img alt="Logo" src="assets/media/logos/upot.png" class="h-35px app-sidebar-logo-minimize" />								
							</a>
							<span class="sidebar-text h-35 app-sidebar-logo-default px-6 min-w-500px fs-4 fw-bold text-start text-gray-700">UPOT: Employee<br>&nbsp;&nbsp;Appraisal System</span>	
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<div class="menu-item pt-5">
								<div class="menu-content">
									<!-- BEGIN TITLE -->
								<div class="menu-heading fw-bold text-uppercase fs-7">Dashboard</div>
							</div>
						</div>
						...
						<div class="menu-item pt-5">
							<div class="menu-content">
								<!-- BEGIN TITLE -->
								<div class="menu-heading fw-bold text-uppercase fs-7">Department</div>
							</div>
						</div>
						...
						<div class="menu-item pt-5">
							<div class="menu-content">
								<!-- BEGIN TITLE -->
								<div class="menu-heading fw-bold text-uppercase fs-7">Assign</div>
							</div>
						</div>
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<span class="menu-title">Messages</span>
										...
										<!--end:Menu link-->
											...
											<span class="menu-link">
												<span class="menu-icon">
													<i class="fa-regular fa-arrow-right-from-bracket fs-1" style="color: #ee535b;"></i>
														<span class="path1"></span>
														<span class="path2"></span>
														<span class="path3"></span>
													</i>
						...
						<i class="bx bx-question-mark fs-2 m-0 px-6"></i></a>
						<i class=''></i>
						</div>
						<!--end::Footer-->
					<!--</div>
